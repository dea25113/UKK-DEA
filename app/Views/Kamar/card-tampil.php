...
<p>
<a href="/kamar/tambah" class="btn btn-secondary btn-sm">Tambah Kamar</a>
</p>
...
<div class="col-md-3">
        ...
        <div class="card-body">
            ...
            <a href="/kamar/edit/<?=$row['id_kamar'];?>" class="btn btn-info btn-info">Edit</a>
            <a href="/kamar/hapus/<?=$row['id_kamar'];?>" class="btn btn-danger btn-danger">Hapus</a>
        </div>
        </div>
</div>
<?php } ?>
